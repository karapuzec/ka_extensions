...
namespace mycomp\field2;

class ControllerField2 extends \extension\ka_extensions\ControllerSettings {

	protected $ext_code = 'mycomp/field2';
...
class_alias(__NAMESPACE__ . '\ControllerField2', 'ControllerExtensionMyCompField2');